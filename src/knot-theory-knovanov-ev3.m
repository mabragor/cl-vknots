...
(Simplify[ans[[1,5]] /. {t -> Pi, q -> E}]) // InputForm
...
>    {x -> 
             ...
             2      4  2    6  3            6  3         2      4  2    6  3 2
        1 + q  t + q  t  + q  t  - Sqrt[-4 q  t  + (1 + q  t + q  t  + q  t ) ]
>       -----------------------------------------------------------------------
                                           5  2
                                        2 q  t
...
ansans = Apart[Simplify[LinearSolve[{{t^(-1) q^(-3) - q^(-1), - (t^(-1) q^(-3) + q^(-1))},
				     {t^(-2) q^(-5) - q^(-1), t^(-2) q^(-5) - q^(-1)}},
				    {t^(-1) q^(-2) + t q^2 - 2, t^(-1) q^(-2) + t q^2 - 2 + 2 t^(-2) q^(-4)}]],
	       t];

a1122 = Apart[Simplify[2 q - Plus @@ ansans], t];

Simplify[q a1122 + t q^3 ansans[[1]] - t q^3 ansans[[2]]]

Simplify[q^3 a1122 + (t q^3)^3 ansans[[1]] - (t q^3)^3 ansans[[2]]]

Expand[Solve[(CC[0]  + CC[1] x +(-1)(CC[0](1 + t^2 q^4) + t^4 q^11 CC[1]) /t^8/q^22 x^2
	      + (-1) CC[1] /t^6/q^18 x^3
	      + (CC[0] + t^4 q^11 CC[1])/t^14/q^40 x^4 == 0)
	     /. Simplify[Solve[CC[1]/t^6/q^18 /(CC[0] + t^4 q^11 CC[1]) t^14 q^40
	     		       == Simplify[q^4 a1122 + (t q^3)^4 ansans[[1]] + (t q^3)^4 ansans[[2]]],
	     		       CC[1]]][[1]]
	     , x]]

                                                      
                   9  3           9  3          11  4
Out[39]= {{x -> -(q  t )}, {x -> q  t }, {x -> q   t }, 
 
              7         11  3    11  4      13  4    15  5
>    {x -> -(q  t) - 2 q   t  - q   t  + 2 q   t  - q   t }}

                                                      
                   9  3           9  3          11  4
Out[37]= {{x -> -(q  t )}, {x -> q  t }, {x -> q   t }, 
 
              7           4  2    4  3      6  3    8  4
>    {x -> -(q  t (1 + 2 q  t  + q  t  - 2 q  t  + q  t ))}}



         
                                 4  2      6  3    8  4
                         (1 + 2 q  t  - 2 q  t  + q  t ) CC[0]
Out[35]= {{CC[1] -> -(--------------------------------------------)}}
                       11  4         6  3    8  4    4  2
                      q   t  (1 - 2 q  t  + q  t  + q  t  (2 + t))

         
                                  4  2      6  3    8  4
                          (1 + 2 q  t  - 2 q  t  + q  t ) CC[0]
Out[34]= {{CC[1] -> -(----------------------------------------------)}}
                       11  4         4  2    4  3      6  3    8  4
                      q   t  (1 + 2 q  t  + q  t  - 2 q  t  + q  t )

            7         4  3      6  4    8  5
Out[33]= -(q  (t + 2 q  t  - 2 q  t  + q  t ))


Solve[(CC[0]  + CC[1] x + (-1/t^8/q^24 CC[0]) x^3 + (-CC[1]/t^8/q^24) x^4 == 0)
      /. {CC[0] -> CC[1] t q^6 (1 + t^2 q^4)}
      , x]

                  
                 8  8/3               1/3  8  8/3              2/3  8  8/3
Out[32]= {{x -> q  t   }, {x -> -((-1)    q  t   )}, {x -> (-1)    q  t   }, 
...
Solve[x - (t^4 q^12)^(-1) x^4 == 0, x]

                           4  4/3               1/3  4  4/3
Out[29]= {{x -> 0}, {x -> q  t   }, {x -> -((-1)    q  t   )}, 
...
ans = Block[{extraPoints = 4},
	    With[{aSeries = 1 + k},
		 FitFamilyWithEigenvaluesAdvanced[Function[{k1},
							   ThreeStrandOne[aSeries /. {k -> k1}]],
						  Join[{aSeries}, {q^2,
								   t^(4/3) q^4,
								   t^(4/3) q^4 Exp[2 Pi I /3],
								   t^(4/3) q^4 Exp[2 Pi I 2/3]
...
(* ### Let's put R1^(-1) R2 eigenvalues to work ### *)
ans = Block[{extraPoints = 4},
	    With[{aSeries = 1 + k},
		 FitFamilyWithEigenvaluesAdvanced[Function[{k1},
							   ThreeStrandPro3[1, {}, aSeries /. {k -> k1}]],
						  Join[{aSeries}, {1, Exp[2 Pi I/3], Exp[4 Pi I/3],
								   (1 + t q^2 + t^2 q^4 - Sqrt[1 + 2 q^2 t - q^4 t^2 + 2 t^3 q^6
											       + t^4 q^8]) /2 /t/q^2,
								   (1 + t q^2 + t^2 q^4 + Sqrt[1 + 2 q^2 t - q^4 t^2 + 2 t^3 q^6
											       + t^4 q^8]) /2 /t/q^2
								  }]]]];
...
(* ### Let's put R1^(-1) R2^2 eigenvalues to work ### *)
ans = Block[{extraPoints = 3},
	    With[{aSeries = 1 + k},
		 FitFamilyWithEigenvaluesAdvanced[Function[{k1},
							   ThreeStrandPro4[1, {}, aSeries /. {k -> k1}]],
						  Join[{aSeries}, {q, -q, q^5*t^2,
								   (2*q^5*t^2)/(1 + q^2*t + q^4*t^2 + q^6*t^3 - 
										Sqrt[-4*q^6*t^3 + (1 + q^2*t)^2*(1 + q^4*t^2)^2]), 
								   (2*q^5*t^2)/(1 + q^2*t + q^4*t^2 + q^6*t^3 + 
										Sqrt[-4*q^6*t^3 + (1 + q^2*t)^2*(1 + q^4*t^2)^2])
								  }]]]];
...
Out[6]//InputForm= q^(-1) + q - 1/(q^3*t) - q^3*t
...
ans = Block[{extraPoints = 10},
	    With[{aSeries = 1 + k},
		 FitFamilyWithEigenvaluesAdvanced[Function[{k1},
							   ThreeStrandThreePrime[aSeries /. {k -> k1}]],
						  Join[{aSeries}, {q^3,
								   t^2 q^6,
								   - t^2 q^6
								  }]]]];
...
ans = Block[{extraPoints = 10},
	    With[{aSeries = 1 + k},
		 FitFamilyWithEigenvaluesAdvanced[Function[{k1},
							   ThreeStrandThreePrimePrime[aSeries /. {k -> k1}]],
						  Join[{aSeries}, {q^3,
								   t^2 q^6,
								   - t^2 q^6
								  }]]]];
...
mat = Table[If[i <= j, AA[i,j], AA[j, i]],
	    {i, 1, 4},
	    {j, 1, 4}];
r1 = {{q, 0, 0, 0},
      {0, q, 0, 0},
...
matn3x3 = Table[If[i <= j, AA[i,j], AA[j, i]],
		{i, 1, 3},
		{j, 1, 3}];
r1n3x3 = {{q, 0, 0}, {0, t q^3, 0}, {0, 0, -t q^3}};
eqnn[1] :=
    0 == (Tr[MatrixPower[r1n3x3, 1] . matn3x3]
	  - (Plus @@ {(* q^(1+1), *)
		      t^(4/3) q^4 1,
		      t^(4/3) q^4 Exp[2 Pi I 2/3],
		      t^(4/3) q^4 Exp[2 Pi I 1/3]}));
eqnn[3] :=
    0 == (Tr[MatrixPower[r1n3x3, 3] . matn3x3]
	  - (Plus @@ {(* q^(3+1), *)
		      t^(8/3) q^8 1,
		      t^(8/3) q^8 Exp[2 Pi I 2/3],
		      t^(8/3) q^8 Exp[2 Pi I 1/3]}));
eqnn[4] :=
    0 == (Tr[MatrixPower[r1n3x3, 4] . matn3x3]
	  - (Plus @@ {(* q^(5+1), *)
		      t^3 q^9,
		      - t^3 q^9,
		      t^4 q^11}));
eqnn[5] :=
    0 == (Tr[MatrixPower[r1n3x3, 5] . matn3x3]
	  - (Plus @@ {(* q^(5+1), *)
		      t^(10/3) q^10 1,
		      t^(10/3) q^10 Exp[2 Pi I 2/3],
		      t^(10/3) q^10 Exp[2 Pi I 1/3]}));

Tr[MatrixPower[r1n3x3, 2] . matn3x3]
    /. Simplify[Solve[{eqnn[1], eqnn[3], eqnn[4], eqnn[5]},
		      {AA[1,1], AA[2,2], AA[3,3]}]][[1]]
...
Out[10]= q  t
                                      ...
                                      1                1
Out[9]= {{AA[1, 1] -> 0, AA[2, 2] -> ---, AA[3, 3] -> ---}}
                                     2 q              2 q

        
Solve::svars: Equations may not give solutions for all "solve" variables.

Out[7]= {{AA[1, 1] -> 0, AA[3, 3] -> AA[2, 2]}}

        
Solve::svars: Equations may not give solutions for all "solve" variables.

Out[5]= {{AA[1, 1] -> q, AA[3, 3] -> AA[2, 2]}}

eig1 = {q, q, t q^3, -t q^3};
eig2 = {t^(4/3) q^4, t^(4/3) q^4 Exp[2 Pi I/3], t^(4/3) q^4 Exp[2 Pi I 2/3]};
eig3 = {q^3, t^2 q^6, -t^2 q^6};
eig4 = {t^(8/3) q^8, t^(8/3) q^8 Exp[2 Pi I/3], t^(8/3) q^8 Exp[2 Pi I 2/3]};
eqnA1 = (Tr[mat] - (Plus @@ eig1) == 0);
eqnA2 = (Tr[r1 . mat] - (Plus @@ eig2) == 0);
eqnA3 = (Tr[r1 . r1 . mat] - (Plus @@ eig3) == 0);
eqnA4 = (Tr[r1 . r1 . r1 . mat] - (Plus @@ eig4) == 0);

FullSimplify[Solve[{eqnA1, eqnA2, eqnA3 (*, eqnA4 *)},
		   {AA[1,1], AA[2,2], AA[3,3]}]]


partAns = {AA[1,1] -> q, AA[2,2] -> q, AA[3,3] -> -1/2/q/t, AA[4,4] -> 1/2/q/t};

eqn4 = ((Tr[MatrixPower[mat, 2]] /. partAns) - (Plus @@ eig1^2) == 0) /. {AA[i_,j_]^2 -> BB[i,j]};
eqn5 = ((Tr[MatrixPower[r1 . mat, 2]] /. partAns) - (Plus @@ eig2^2) == 0) /. {AA[i_,j_]^2 -> BB[i,j]};
eqn6 = ((Tr[MatrixPower[r1 . r1 . mat, 2]] /. partAns) - (Plus @@ eig3^2) == 0) /. {AA[i_,j_]^2 -> BB[i,j]};
eqn65 = ((Tr[MatrixPower[mat . r1 . r1, 2]] /. partAns) - (Plus @@ eig3^2) == 0) /. {AA[i_,j_]^2 -> BB[i,j]};
eqn655 = ((Tr[MatrixPower[mat . r1 . r1, 2]] /. partAns) - (Plus @@ eig3^2) == 0) /. {AA[i_,j_]^2 -> BB[i,j]};
eqn7 = ((Tr[MatrixPower[mat . r1, 2]] /. partAns) - (Plus @@ eig2^2) == 0) /. {AA[i_,j_]^2 -> BB[i,j]};

FullSimplify[Solve[{eqn4, eqn5, eqn6, eqn65, eqn7},
		   {BB[1,2], BB[1,3], BB[1,4], BB[2,3], BB[2,4], BB[3,4]}]]
...
Solve::svars: Equations may not give solutions for all "solve" variables.
                                                    ...
                                                    -1                  1
Out[51]= {{AA[2, 2] -> 2 q - AA[1, 1], AA[3, 3] -> -----, AA[4, 4] -> -----}}
                                                   2 q t              2 q t


MyExpr[k_] :=
    Factor[Expand[FullSimplify[(ThreeStrandFour[1 + 3 k]
				- q^(12 k + 1) (1 + q^2))/(1 + t q^4)/t^2/q^(12 k)/q^5
			       (* - t^(8 k) q^(24 k) (t^3 q^9 + t^2 q^5) *)
			      ]]];

Block[{k = 6},
      Expand[(MyExpr[k] - MyExpr[k-1])/t^(8 k - 6)/q^(12 k - 10)]]




ans = Block[{extraPoints = 5},
	    With[{aSeries = 1 + k},
		 FitFamilyWithEigenvaluesAdvanced[Function[{k1},
							   ThreeStrandFour[aSeries /. {k -> k1}]],
						  Join[{aSeries}, {q^4,
								   t^(8/3) q^8,
								   t^(8/3) q^8 Exp[2 Pi I /3],
								   t^(8/3) q^8 Exp[2 Pi I 2/3]}]]]];

(* (\* ### vv I've discovered that contribution of q^n is always the same ### *\) *)
(* - (q^((k+1) (n + delta)) *)
(* 	(1 + q^2 + t^2 q^4 + t^3 q^8 + t^5 q^10 + t^5 q^12) *)
(* 	/q^3 q^(2 nwind) /(1 - t^2 q^3)/(1 + t^2 q^3))]] *)
...
(* ThreeStrandPro3[2, {}, 9] // InputForm *)
                                                                                                                        
ans = Solve[eqns (* /. {t -> -1} *),
	    Map[CC[#] &, Range[1,theOrder]]];
ans1 = FullSimplify[ans] // InputForm;
...
Out[4]//InputForm= 
{{CC[1] -> -(((1 + q^4*t^2)*CC[0])/(q^2*t)), 
  CC[2] -> (1 - 1/(q^2*t) - q^2*t)*CC[0], 
  CC[3] -> -(((1 + q^4*t^2)*CC[0])/(q^2*t)), CC[4] -> CC[0]}}



(* ### TADA ### *)
                                                                                                                                        Something went wrong running JavaKh; nothing was returned. The command line\
 
>   was: 
!java -classpath\
 
>   "/home/popolit/quicklisp/local-projects/cl-vknots/src/KnotTheory/JavaKh-v\
 
>   2/bin:/home/popolit/quicklisp/local-projects/cl-vknots/src/KnotTheory/Jav\
 
>   aKh-v2/jars/commons-cli-1.0.jar:/home/popolit/quicklisp/local-projects/cl\
 
>   -vknots/src/KnotTheory/JavaKh-v2/jars/commons-io-1.2.jar:/home/popolit/qu\
 
>   icklisp/local-projects/cl-vknots/src/KnotTheory/JavaKh-v2/jars/commons-lo\
 
>   gging-1.1.jar:/home/popolit/quicklisp/local-projects/cl-vknots/src/KnotTh\
 
>   eory/JavaKh-v2/jars/log4j-1.2.12.jar"  org.katlas.JavaKh.JavaKh --mod 0 <\
 
>   pd 2> JavaKh.log
There may have been an error log produced by Java: 
Exception in thread "main" java.lang.OutOfMemoryError: GC overhead limit exceeded
	at org.katlas.JavaKh.CannedCobordismImpl.reverseMaps(CannedCobordismImpl.java:161)
	...
	at org.katlas.JavaKh.Komplex.deLoop(Komplex.java:741)
	at org.katlas.JavaKh.Komplex.reduce(Komplex.java:514)
	at org.katlas.JavaKh.Komplex.generateFast(Komplex.java:1735)
	at org.katlas.JavaKh.JavaKh.main(JavaKh.java:114)

StringReplace::strse: 
   String or list of strings expected at position 1 in 
    StringReplace[#1, {q -> #1, t -> #2, Z -> ZMod}].
...
General::stop: Further output of StringReplace::strse
...
FullSimplify[ans][[1]] // InputForm

Out[8]//InputForm= 
{CC[2] -> 0, CC[3] -> -(CC[0]/(q^12*t^4)), CC[4] -> -(CC[1]/(q^12*t^4))}


(* ### Answer for recursion for (R_1 R_2)^n ### *)
...
Out[6]= {{x -> 1}, {x -> -(-1)   }, {x -> (-1)   }, 
                ...
                2      4  2               2      4  2      6  3    8  4
           1 + q  t + q  t  - Sqrt[1 + 2 q  t - q  t  + 2 q  t  + q  t ]
>    {x -> -------------------------------------------------------------}, 
                                         2
                                      2 q  t
...
ans = Apart[Factor[Simplify[LinearSolve[{{t q^2 - 1, -t q^2 - 1},
					 {t^3 q^6 - 1, -t^3 q^6 - 1}},
					{t^(4/3) q^3 - 2 q, t^(8/3) q^5 - 2 q}] /. {t -> Pi^3}]],
	    Pi];
...
Simplify[Pi^3 q^2 (ans[[1]] - ans[[2]]) - (ans[[1]] + ans[[2]])]
                   4  2
Out[11]= q (-2 + Pi  q )

Simplify[Pi^9 q^6 (ans[[1]] - ans[[2]]) - (ans[[1]] + ans[[2]])]

           8  5
Out[12]= Pi  q

Expand[Simplify[q^2 (2 q - (ans[[1]] + ans[[2]])) + (Pi^3 q^3)^2 (ans[[1]] + ans[[2]])]]

             6  7     8  7     10  9
Out[34]= 2 Pi  q  + Pi  q  - Pi   q

Expand[Factor[FullSimplify[(Pi^3 q^3)^4 q^(-4) (ans[[1]] + ans[[2]]) - (ans[[1]] + ans[[2]])]] + 2 q]

           8  5     10  7       12  9     14  9     16  11
Out[29]= Pi  q  - Pi   q  + 2 Pi   q  + Pi   q  - Pi   q
                           ...
                           2      4  2
                     (1 + q  t + q  t ) CC[0]
Out[4]= {{CC[1] -> -(------------------------), CC[2] -> CC[0], 
                                2
                               q  t
 
                                      1      2
>     CC[3] -> -CC[0], CC[4] -> (1 + ---- + q  t) CC[0], CC[5] -> -CC[0]}}
                                      2
                                     q  t


Solve[1 - 1/q x - 1/t^2/q^6 x^2 + 1/t^2/q^7 x^3 == 0, x]

                             3             3
Out[11]= {{x -> q}, {x -> -(q  t)}, {x -> q  t}}

Solve::svars: Equations may not give solutions for all "solve" variables.

                      CC[0]              CC[0]            CC[0]
Out[10]= {{CC[1] -> -(-----), CC[2] -> -(-----), CC[3] -> -----}}
                        q                 6  2             7  2
                                         q  t             q  t

(* Simplify[Solve[1 - t^(-4) q^(-11) x - t^(-6) q^(-18) x^2 + t^(-10) q^(-29) x^3 == 0, x]] *)



                      CC[0]               CC[0]              CC[0]
Out[17]= {{CC[1] -> -(------), CC[2] -> -(------), CC[3] -> -------}}
                       11  4               18  6             29  10
                      q   t               q   t             q   t


                           6  4                          2  2
                     (1 + q  t ) CC[0]            (-1 + q  t ) CC[0]
Out[9]= {{CC[1] -> -(-----------------), CC[2] -> ------------------, 
                           11  4                         18  6
                          q   t                         q   t
...
>     CC[3] -> -----------------, CC[4] -> -(-------)}}
                    ...
                    q   t                    q   t
                                                                ...
                                                                6  4
                                                          (1 + q  t ) CC[4]
Out[95]= {{CC[1] -> 0, CC[2] -> 0, CC[3] -> 0, CC[5] -> -(-----------------), 
                                                                11  4
                                                               q   t
 
                      2  2                        6  4
               (-1 + q  t ) CC[4]           (1 + q  t ) CC[4]
>     CC[6] -> ------------------, CC[7] -> -----------------, 
                      18  6                       29  10
                     q   t                       q   t
...
>     CC[8] -> -(-------)}}
                 ...
                 q   t
                      ...
                      CC[0]              CC[0]            CC[0]
Out[62]= {{CC[1] -> -(-----), CC[2] -> -(-----), CC[3] -> -----}}
                        q                 6  2             7  2
                                         q  t             q  t


(* {t^(10/3) q^10, *)
(*  t^(10/3) q^10 Exp[2 Pi I /3], *)
(*  t^(10/3) q^10 Exp[2 Pi I 2/3]} *)

MyExpr[kk_] :=
    Block[{k = 4},
	  Expand[Factor[Expand[(ThreeStrandPro[k, kk] - q^(5 kk - 3) (1 + q^2))/t^2/q^(5 kk + 1)
			       - (1 + t q^4)]]]];
...
Block[{kk = 3},
      Expand[MyExpr[kk]]]
          ...
          2  2    4  2    6  3    8  3    6  4    10  5    8  6    10  6
Out[56]= q  t  + q  t  + q  t  + q  t  + q  t  + q   t  + q  t  + q   t  + 
 
      10  7    12  7    14  7    14  8    16  10    18  10
>    q   t  + q   t  + q   t  + q   t  + q   t   + q   t

         
          2  2    4  2    6  3    8  3      6  4      8  4    10  6    12  6
Out[55]= q  t  + q  t  + q  t  + q  t  + 2 q  t  + 2 q  t  + q   t  + q   t
...
Out[54]= q  t  + q  t
          ...
          2  2    4  2    6  3    8  3    6  4    10  5    8  6    10  6
Out[53]= q  t  + q  t  + q  t  + q  t  + q  t  + q   t  + q  t  + q   t  + 
 
      12  7    14  7    12  8    16  9      14  10      16  10    16  11
>    q   t  + q   t  + q   t  + q   t  + 2 q   t   + 3 q   t   + q   t   + 
 
      20  11    20  12    22  14    24  14
>    q   t   + q   t   + q   t   + q   t
...
ans = Block[{extraPoints = 10, n = 4},
	    With[{aSeries = 5 + k},
		 FitFamilyWithEigenvaluesAdvanced[Function[{k1},
							   ThreeStrandPro[n, aSeries /. {k -> k1}]],
						  Join[{aSeries},
						       {q^5,
							t^3 q^9,
							- t^3 q^9,
	    ...
	    With[{aSeries = 5 + k},
		 FitFamilyWithEigenvaluesAdvanced[Function[{k1},
						  ...
						  Join[{aSeries},
						       {q^6,
							t^4 q^12,
							t^4 q^12 Exp[2 Pi I /3],
							t^4 q^12 Exp[2 Pi I 2/3]
						       }]]]];
...
Module[{cc = 6},
       ...
       ansUL = Block[{extraPoints = 2},
		     With[{aSeries = -4 - k,
			   bSeries = 4 + k},
			  FitFamilyWithEigenvaluesAdvanced[Function[{k1, k2},
								    FifthNonToricKhovanovPrime[aSeries /. {k -> k1},
											       bSeries /. {k -> k2},
											       cc]],
							   Join[{aSeries}, PosFundEigenvalues[]],
							   Join[{bSeries}, PosFundEigenvalues[]]]]];
       ...
       Block[{maxAbs = 5},
	     picc[cc] = Module[{aa, bb},
			       Table[Module[{ulQ = (0 === Simplify[TheorKhovanov[aa, bb, ansUL]
								   - FifthNonToricKhovanovPrime[aa, bb, cc]]),
